...
import { FaBars, FaBoxes, FaCalendarAlt, FaFileAlt, FaFolderOpen, FaTimes, FaUserAlt } from "react-icons/fa";
        ...
        >
          <nav className="space-y-4 mt-16 lg:mt-0">
            ...
            <div className="space-y-2">
              ...
              <SidebarButton label="Inventario" icon={<FaBoxes />} />
              <SidebarButton label="Documentos" icon={<FaFileAlt />} />
            </div>
            ...
            {/* Grupo secundario */}
            <div className="space-y-2">
              <SidebarButton label="Administradores" icon={<FaUserShield />} />
              <SidebarButton label="Gerente Operativo" icon={<FaUserTie />} />
              <SidebarButton label="Pilotos" icon={<FaUserAlt />} />
              <SidebarButton label="Socios" icon={<FaUsers />} />
              <SidebarButton label="Calendario" icon={<FaCalendarAlt />} />
            </div>
          </nav>
        </aside>
